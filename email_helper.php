...
class EmailHelper {
    ...
    public function sendOrderConfirmation($orderData) {
        // Notif internal staff M2B
        $this->sendEmail('mora.multiberkah@gmail.com', '[NEW ORDER] ' . $orderData['order_id'] . ' - ' . $orderData['buyer_name'], $this->getOrderConfirmationHTML($orderData));
